...
function displayError(error, loc, offset) {
	...
	link.rel = "stylesheet";
	link.type = "text/css";
	link.href = chrome.runtime.getURL("/WebContent/content_error.css");
	...
	imgError.src = chrome.runtime.getURL("/WebContent/error.gif");
...
function displayUI(theme, html) {
	...
	content += '<link rel="stylesheet" type="text/css" href="' + chrome.runtime.getURL("/WebContent/jsonview-core.css") + '">';
	...
	optionsElement.src = chrome.runtime.getURL("/WebContent/options.png");
