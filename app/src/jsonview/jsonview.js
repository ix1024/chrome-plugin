...
if(is_json || is_jsonp){
  ...
  var links = '<link rel="stylesheet" type="text/css" href="'+chrome.extension.getURL("stylesheets/json-view-default.css")+'">' + 
              '<script type="text/javascript" src="'+chrome.extension.getURL("src/jsonview/default.js")+'"></script>';
